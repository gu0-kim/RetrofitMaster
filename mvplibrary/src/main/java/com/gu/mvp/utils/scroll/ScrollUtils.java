...
public final class ScrollUtils {
   ...
   *
   * <p>This is just a wrapper for Math.min() and Math.max(). This may be useful if you feel it
   * confusing ("Which is min and which is max?").
   *
   ...
   * Mix two colors.
   *
   * <p>{@code toColor} will be {@code toAlpha/1} percent, and {@code fromColor} will be {@code
   * (1-toAlpha)/1} percent.
   *
  ...
  /**
   * Convert CYMK color to RGB color. This method doesn't check if cmyk is not null or have 4
   * elements in array.
   *
   * @param cmyk Target CYMK color. Each value should be between 0.0f to 1.0f, and should be set in
   *     this order: cyan, magenta, yellow, black.
